      ...
      <Container className="spacing">
        ...
        <GridThree>
          <div className="spacing">
            <StaticImage
              src="../images/calgary-landscaper-benefits.jpg"
              alt="calgary landscaping company"
              width={50}
            />
            <h3 className="body--large caps">We Bring Your ideas to life</h3>
            <p>
          ...
          <div className="spacing">
            <StaticImage
              ...
              width={50}
            />
            <h3 className="body--large caps">we save you money and time</h3>
            <p>
          ...
          <div className="spacing">
            <StaticImage
              ...
              width={50}
            />
            <h3 className="body--large caps">we provide reduced maintenance</h3>
            <p>
